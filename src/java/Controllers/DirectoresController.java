...
import Facades.DirectoresFacade;
...
public class DirectoresController implements Serializable {
    ...
    @EJB
    private Facades.DirectoresFacade ejbFacade;
    ...
    private DirectoresFacade getFacade() {
        return ejbFacade;
    }
    ...
    public SelectItem[] getItemsAvailableSelectOne() {
        return JsfUtil.getSelectItemsName(ejbFacade.findAll(), true);
    }

    public Directores getDirectores(java.lang.Integer id) {
    ...
    public static class DirectoresControllerConverter implements Converter {
        ...
        public Object getAsObject(FacesContext facesContext, UIComponent component, String value) {
            ...
            return controller.getDirectores(getKey(value));
        }
        ...
        public String getAsString(FacesContext facesContext, UIComponent component, Object object) {
            ...
            if (object instanceof Directores) {
                ...
                return getStringKey(o.getCodDirector());
            } else {
